 ...
 <div class='parent'>
  <div class='slider'>
   <button type="button" id='right' class='right button1' name="button">
   ...
   <button type="button" id='left' class='left button1' name="button">
   ...
   <svg id='svg2' class='up2' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      <circle id='circle1' class='circle1 steap' cx="504px" cy="49%" r="20"  />
      <circle id='circle2' class='circle2 steap' cx="504px" cy="49%" r="100"  />
      <circle id='circle3' class='circle3 steap' cx="504px" cy="49%" r="180"  />
      <circle id='circle4' class='circle4 steap' cx="504px" cy="49%" r="260"  />
      <circle id='circle5' class='circle5 steap' cx="504px" cy="49%" r="340"  />
      <circle id='circle6' class='circle6 steap' cx="504px" cy="49%" r="420"  />
      <circle id='circle7' class='circle7 steap' cx="504px" cy="49%" r="500"  />
      <circle id='circle8' class='circle8 steap' cx="504px" cy="49%" r="580"  />
      <circle id='circle9' class='circle9 steap' cx="504px" cy="49%" r="660"  />
    </svg>
